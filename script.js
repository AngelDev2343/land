...
const bootMessages = [
  ...
  Yo me encargo de hacerlo realidad.</span>
    ...
    contact: {
      ...
      content: () => `
        ...
        <div class="contact-item" onclick="window.open('https://github.com/AngelDev2343','_blank')">
          <div class="contact-icon"><img src="https://raw.githubusercontent.com/AngelDev2343/land/refs/heads/main/gifs/github.gif" width="20px" style="border-radius: 50%"></div>
          <div class="contact-info">
            <label>GitHub</label>
    ...
    whyai: {
      ...
      content: () => `
        ...
        <div class="preview-browser">
          ...
          <img src="https://angeldev2343.github.io/land/gifs/1.gif" style="width: 100%; height: auto min-height: 500px;">
        </div>
        ...
        <div class="preview-browser">
          <div class="preview-chrome">
            ...
            <div class="preview-url">angeldev2343.github.io/Bio3D/</div>
                  ...
                  <img src="https://github.com/AngelDev2343/land/blob/main/gifs/3d1.gif?raw=true" style="width: 100%; height: auto min-height: 500px;">
          </div>
        <div style="padding:12px;background:var(--bg3);border-left:2px solid var(--green);margin-bottom:12px;font-size:11px;color:var(--text-dim);line-height:1.8">
    ...
    twin: {
      ...
      content: () => `
          ...
          <img src="https://github.com/AngelDev2343/land/blob/main/gifs/twin.gif?raw=true" style="width: 100%; height: auto; min-height: 500px;">
          </div>
      ...
      fender: {
          ...
          content: () => `
              ...
              <img src="https://github.com/AngelDev2343/land/blob/main/gifs/fender.gif?raw=true" style="width: 100%; height: auto; min-height: 500px;">
              </div>
      ...
      fluttertool: {
          ...
          content: () => `
              ...
              <img src="https://raw.githubusercontent.com/AngelDev2343/FlutterTool/refs/heads/main/power.PNG" style="width: 100%; height: auto; min-height: 500px;">
              </div>
  ...
  function handleTerminalInput(e) {
    ...
    const responses = {
      ...
      projects: `<span class="out">5 proyectos encontrados:<br>  ├─ WhyAI       [JS, WebAI]<br>  ├─ Bio3D       [WebGL, Gestos]<br>  ├─ Cerimex     [PHP, MySQL]<br>  ├─ Twin Msgnr  [Node.js, WS]<br>  └─ Fender      [Python, Django]</span>`,
      ...
      help: `<span class="out">Comandos: whoami, projects, skills, contact, github, ls, pwd, date, clear, matrix, sudo</span>`,
      '': `<span class="out"></span>`
    };
